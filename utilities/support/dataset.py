...
# ---------------------------------------------------------------------------
# Inlined from upstream src/utils/util.py — used only by the test-time
# stitching dataset below. Original source: DeepCAD-PyTorch
...
def get_coordinate(img_size, patch_size, patch_interval):
    """Compute the (stack, patch) coordinate pairs for tile-based stitched
    inference. Returns a list of dicts with init_/end_ for each axis."""
