...
# -*- coding: utf-8 -*-
#
# CaImAn documentation build configuration file, created by
...
with open('../../VERSION', 'r') as verfile:
    version = verfile.read().strip() # sphinx wants this not to include alpha/betta/rc tags
release = version
...
latex_documents = [
    (master_doc, 'CaImAn.tex', 'Ca source separation Documentation',
     'AG and EP', 'manual'),
]
...
man_pages = [
    (master_doc, 'CaImAn', 'CaImAn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CaImAn', 'CaImAn Documentation',
     author, 'CaImAn', 'One line description of project.',
     'Miscellaneous'),
]
